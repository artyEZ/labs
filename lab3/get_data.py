...
def get_data_xy(input_file_x: str, input_file_y: str,
    ...
    """
    :param input_file_x: file with column "Data"
    :param input_file_y: file with column "Exchange rate"
    :param date: necessary date
    :return: value for necessary date
    """
...
def get_data_from_week_and_years(input_directory: str, date: datetime.date) -> Union[numpy.float64, None]:
    """
    :param input_directory: directory with sorted file by weeks or years
    :param date: necessary date
    :return: value for necessary date
    """
