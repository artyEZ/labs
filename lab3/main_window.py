...
import split_by_column
import sorted_by_weeks
import sorted_by_years
import get_data
import iterators
import parser
...
class DataSetApp(QWidget):
    ...
    def start_div_data(self):
        ...
        split_by_column.write_to_file(file_path, output_directory)
    ...
    def start_data_to_years(self):
        ...
        output_directory = QFileDialog.getExistingDirectory(
            self, 'Select Folder')
        sorted_by_years.write_to_file(file_path, output_directory)
    ...
    def start_data_to_weeks(self):
        ...
        output_directory = QFileDialog.getExistingDirectory(
            self, 'Select Folder')
        sorted_by_weeks.write_to_file(file_path, output_directory)
    ...
    def start_parser(self):
        ...
        output_directory = QFileDialog.getExistingDirectory(
            self, 'Select Folder')
        parser.write_to_file(output_directory)
    ...
    def search_dialog(self, choice_flag: int):
        ...
        if is_input_correct and choice_flag == 1:
            ...
            output = get_data.get_data_from_week_and_years(
    ...
    def start_iter_from_weeks(self):
        ...
        file_path = QFileDialog.getExistingDirectory(
            self, 'Select Folder')
        object = iterators.DateIteratorYearOrWeek(file_path)
    ...
    def start_iter_from_source(self):
        ...
        file_path = QFileDialog.getOpenFileName(
            self, 'Select Folder', filter="*.csv")[0]
        object = iterators.DateIterator(file_path)
    ...
    def start_iter_from_x_y(self):
        ...
        object = iterators.DateIteratorXY(file_path_x, file_path_y)
